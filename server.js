...
(async () => {
try {
await mongoose.connect('mongodb://localhost:27017/financial_dashboard', { 
...
const getAdvice = (income, expenses, savings) => { 
let advice = '';
...
// Route to submit financial data and receive advice 
...
const financialEntry = new FinancialData({ income, expenses, savings }); 
await financialEntry.save();
// Send response with advice 
res.json({ advice });
} catch (err) {
